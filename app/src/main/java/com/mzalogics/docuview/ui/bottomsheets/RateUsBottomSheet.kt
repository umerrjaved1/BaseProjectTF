package com.mzalogics.docuview.ui.bottomsheets
...
import com.mzalogics.docuview.databinding.BottomSheetRateUsBinding
...
class RateUsBottomSheet(
    ...
    private fun updateRating(rating: Int) {
        ...
        stars.forEachIndexed { index, star ->
            if (index < rating) {
                star.setImageResource(com.mzalogics.docuview.R.drawable.ic_star)
                star.setColorFilter(ContextCompat.getColor(currentContext, R.color.holo_orange_light))
            } else {
                star.setImageResource(com.mzalogics.docuview.R.drawable.ic_star_non_fil)
