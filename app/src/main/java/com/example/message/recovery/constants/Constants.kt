package com.example.message.recovery.constants
...
object Constants {
    ...
    // Weekly plan (ACTIVE)
    // Replace these Play Console product IDs when cloning this template.
    const val SKU_SUBSCRIPTION_WEEKLY = "vidwave_weekly"
    ...
    const val SKU_SUBSCRIPTION_YEARLY   = "vidwave_yearly"
    ...
    const val APP_FOLDER = "MessageRecovery"
    const val EXTRA_PREMIUM_FROM_SPLASH = "extra_premium_from_splash"
    const val EXTRA_PREMIUM_FROM_SURVEY = "extra_premium_from_survey"
}
