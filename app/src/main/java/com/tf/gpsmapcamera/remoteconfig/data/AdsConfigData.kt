...
data class GlobalAdRulesConfig(
    ...
    val maxAdsPerDay: Int = 5000,
    val nativeMaxPerSession: Int = 5000,
    val maxAdsPerSession: Int = 500,
    val interstitialMaxPerSession: Int = 100,
    val openAdMaxPerSession: Int = 1000,
    val bannerMaxPerSession: Int = Integer.MAX_VALUE,
    val sessionCooldownSeconds: Int = 10,
