...
import com.tf.gpsmapcamera.databinding.FullNativeAdItemViewPagerBinding
import com.tf.gpsmapcamera.databinding.ItemOnboardingBinding
...
class OnboardingAdapter(
    ...
    private fun showPreloadedAd(
        ...
        try {
            ...
            binding.includeAd.btnCloseAd.visibility = View.VISIBLE
            binding.includeAd.btnCloseAd.setClickWithTimeout {
                advanceViewPager(binding)
            }
    ...
    private fun advanceViewPager(binding: FullNativeAdItemViewPagerBinding) {
        try {
            ...
            Log.e(TAG, "Failed to advance ViewPager: ${e.message}")
        }
    }
