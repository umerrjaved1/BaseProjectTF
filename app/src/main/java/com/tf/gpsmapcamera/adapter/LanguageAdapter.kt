...
import com.tf.gpsmapcamera.databinding.ItemLangHeaderBinding
import com.tf.gpsmapcamera.databinding.ItemLanguageBinding
...
class LanguageAdapter(
    ...
    inner class LanguageViewHolder(private val binding: ItemLanguageBinding) :
        ...
        fun updateSelection() {
            binding.ivChecked.setImageResource(R.drawable.ic_selected)
