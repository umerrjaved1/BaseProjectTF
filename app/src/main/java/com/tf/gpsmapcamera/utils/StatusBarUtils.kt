...
//            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
    ...
    fun applyEdgeToEdge(
        ...
        window.statusBarColor = androidx.core.content.ContextCompat.getColor(activity, com.tf.gpsmapcamera.R.color.bg_color)
        // Set navigation bar color for all APIs
        window.navigationBarColor = activity.getColor(com.tf.gpsmapcamera.R.color.white)
        ...
        if (activity.javaClass.simpleName == "AdActivity" || activity.javaClass.simpleName == "StartActivity" ||
            activity.javaClass.simpleName == "PremiumActivity" || activity.javaClass.simpleName == "OnboardingActivity") {
