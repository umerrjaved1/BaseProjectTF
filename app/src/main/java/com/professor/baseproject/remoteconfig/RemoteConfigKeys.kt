...
object RemoteConfigKeys {
    ...
    // Removed: FIRST_LAUNCH ("first_launch") was never read, and NOTIFICATION_TIME was a
    // second constant for the same "notification_time" key as NOTIFICATION_REPEAT_INTERVAL.
}
